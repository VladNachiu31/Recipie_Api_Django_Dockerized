...
class PrivateRecipeAPITest(TestCase):
    ...
    def test_partial_update(self):
        ...
        original_link = 'htts://example.com/recipe.pdf'
    ...
    def test_delete_other_users_recipe_error(self):
        """Test trying to delete anouther users recipe fives error."""
        new_user = create_user(email='user2@example.com', password='test123')
    ...
    def test_filtering_by_ingredients(self):
        ...
        r2 = create_recipe(user=self.user, title='Chicken Appreciator')
...
class ImageUploadTests(TestCase):
    ...
    def test_upload_image(self):
        """Test uploading and image to a recipe."""
